...
// //        return communityCollegeService.getCommunityCollegeById(id).orElseThrow(() -> new RuntimeException("Community college not found"));
// //    }
// //
// //    @PostMapping
...
// //        CommunityCollege existing = communityCollegeService.getCommunityCollegeById(id).orElseThrow(() -> new RuntimeException("Community college not found"));
